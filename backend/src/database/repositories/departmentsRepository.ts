...
class DepartmentsRepository {
  ...
  static async update(id, data, options: IRepositoryOptions) {
    ...
    let record = await options.database.departments.findOne(      
      {
        where: {
          id,
  ...
  static async findById(id, options: IRepositoryOptions) {
    ...
    const record = await options.database.departments.findOne(
      {
        where: {
          id,
          tenantId: currentTenant.id,
  ...
  static async count(filter, options: IRepositoryOptions) {
    ...
    return options.database.departments.count(
      {
        where: {
          ...filter,
          tenantId: tenant.id,
  ...
  static async findAndCountAll(
    ...
    let {
      rows,
      count,
    } = await options.database.departments.findAndCountAll({
      where,
      include,
