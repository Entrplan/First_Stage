const es = {
  ...
  entities: {
    ...
    academicCertificates: {
      ...
      destroyAll: {
        success:
          'الشهادات الاكاديمية(s) eliminado con éxito',
      },
      edit: {
    ...
    trainingCertificates: {
      ...
      destroyAll: {
        success:
          'الشهادات التدريبية(s) eliminado con éxito',
      },
      edit: {
    ...
    professionalCertifications: {
      ...
      exporterFileName:
        'exportacion_professionalCertifications',
      list: {
        menu: 'الشهادات المهنية',
    ...
    administrativeFinancialPowers: {
      ...
      exporterFileName:
        'exportacion_administrativeFinancialPowers',
      list: {
        menu: 'AdministrativeFinancialPowers',
      ...
      create: {
        success:
          'الصلاحيات الإدارية و المالية guardado con éxito',
      },
      update: {
        success:
          'الصلاحيات الإدارية و المالية guardado con éxito',
      ...
      destroy: {
        success:
          'الصلاحيات الإدارية و المالية eliminado con éxito',
      },
      destroyAll: {
        success:
          'الصلاحيات الإدارية و المالية(s) eliminado con éxito',
      },
      edit: {
