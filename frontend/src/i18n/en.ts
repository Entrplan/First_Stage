const en = {
  ...
  entities: {
    ...
    administrativeFinancialPowers: {
        ...
        exporterFileName: 'administrativeFinancialPowers_export',
        list: {
          menu: 'AdministrativeFinancialPowers',
          title: 'AdministrativeFinancialPowers',
        },
        create: {
          success: 'الصلاحيات الإدارية و المالية successfully saved',
        },
        update: {
          success: 'الصلاحيات الإدارية و المالية successfully saved',
        },
        destroy: {
          success: 'الصلاحيات الإدارية و المالية successfully deleted',
        },
        destroyAll: {
          success: 'الصلاحيات الإدارية و المالية(s) successfully deleted',
        },
        edit: {
